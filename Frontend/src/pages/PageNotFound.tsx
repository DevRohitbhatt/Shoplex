import url from '../assets/character_6.png';

const PageNotFound = () => {
	return (
		<div className='mx-auto w-fit'>
			<h1 className='mt-10 text-3xl font-bold text-center'>Sorry, Page Not Found!</h1>
			<p className='mt-8 mb-12 text-center text-gray-500 max-w-96 text-wrap'>
			...
			>
				...
				<path
					...
					opacity='0.2'
				></path>
				<image href={url} height='300' x='205' y='30'></image>
				<path
					fill='#FFAB00'
