...
const Checkout = () => {
	...
	return (
				...
				<main className='lg:w-2/3'>
					...
					<div className='grid grid-cols-2 gap-5 mt-6'>
						...
						<div className='relative col-span-2'>
							<select
								className='w-full px-3 pb-2 text-sm text-gray-400 bg-gray-100 rounded-lg outline-none appearance-none pt-7 peer cursor-text'
								id='country'
								name='country'
							>
      ...
      "icon": "<img class=\"inline-block w-4 h-4 rounded-full\" src=\"../assets/vendor/svg-country-flags/png100px/zw.png\" alt=\"Zimbabwe\" />"}'
							...
							<label
								htmlFor='country'
								className='absolute px-3 font-medium text-gray-400 duration-150 ease-in-out transform translate-y-1 start-0 cursor-text peer-focus:text-black '
							>
								Country
							</label>
