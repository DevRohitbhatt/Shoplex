	...
	return (
		<div className='fixed inset-0'>
			<div className='relative flex '>
				<div
					ref={btnRef}
					className={`fixed bottom-0 top-0 transform z-50 duration-300 ease-in-out lg:static ${
				...
				<div className='relative w-full px-4'>
					{sidebarIsOpen ? <div className='absolute lg:hidden inset-0 z-40 bg-black/75'></div> : null}
					<div className='flex items-center sticky top-0 z-20 bg-white justify-between w-full lg:justify-end lg:px-6 py-3'>
						<div
							className={`${
