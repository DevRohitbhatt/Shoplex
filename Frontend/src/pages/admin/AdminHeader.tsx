...
const AdminHeader = () => {
	return (
		<div className='flex items-center justify-between w-full lg:px-6 lg:justify-end'>
			<div className='lg:hidden p-2.5 rounded-full hover:bg-gray-100 cursor-pointer'>
